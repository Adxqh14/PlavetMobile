...
interface TutoresTableListProps {
  isLoading: boolean;
  isReadOnly: boolean;
  filteredTutores: Tutor[];
  paginatedTutores: Tutor[];
  currentPage: number;
  totalPages: number;
...
export function TutoresTableList({
  isLoading,
  isReadOnly,
  filteredTutores,
  paginatedTutores,
  ...
  return (
    <>
      <TutorTable
        ...
        onDelete={isReadOnly ? undefined : onDeleteRequest}
